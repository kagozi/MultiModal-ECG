...
def train_model(config, metadata, device):
    ...
    if loss_type == 'focal':
        ...
        class_weights1 = torch.FloatTensor([0.25, 0.75, 0.5, 0.15, 0.5])
        class_weights2 = torch.FloatTensor([1, 5, 2.5, 1, 2.5])
        class_weights3 = torch.FloatTensor([0.25, 0.75, 0.75, 0.25, 0.75])
